...
export default function Footer({ t = ar }: { t?: Messages }) {
  const f = t.footer;
  return (
      ...
      <div className="mx-auto hidden max-w-[1200px] flex-col gap-12 lg:flex">
        <div className="grid grid-cols-[1.5fr_1fr_1fr_1fr] gap-10">
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <a href={phoneHref} dir="ltr" className={`self-start ${link}`}>
              {PHONE_DISPLAY}
            </a>
          ...
          <div className="flex flex-col gap-2.5">
            ...
            <a href={INSTAGRAM_URL} target="_blank" rel="noopener" dir="ltr" className={`self-start ${link}`}>
              {INSTAGRAM_HANDLE}
            </a>
          </div>
          <div className="flex flex-col gap-2.5">
